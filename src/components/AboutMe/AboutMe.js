      ...
      <div className={'section section_type_about-me'}>
        ...
        <div className={'about-me__info'}>
          <article className={'about-me__info-article'}>
            ...
            <h4 className={'about-me__info-job'}>Фронтенд-разработчик, 36
                                                 лет.</h4>
            <p className={'about-me__info-bio'}>
              Привет! Я училась и долго жила в Екатеринбурге,
              сейчас живу с семьей (мужем и дочерью) в США. Раньше работа в
              области
              международных поставок и логистики, в декрете решила сменить род
              деятельности,
              поступила на курсы Яндекс.Практикума и почти их закончила. Как
              закончу диплом,
              буду искать работу React-разработчиком. </p>
